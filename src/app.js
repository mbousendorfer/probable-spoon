...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=29";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=23";
import { init as initRightPanel } from "./components/right-panel.js?v=26";
...
import { renderSession } from "./screens/session.js?v=59";
